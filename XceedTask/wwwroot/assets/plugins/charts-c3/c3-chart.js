...
(function (global, factory) {
    ...
    var CLASS = {
        ...
        selectedXceedTask: 'c3-selected-XceedTask',
    ...
    ChartInternal.prototype.redraw = function (options, transitions) {
        ...
        // XceedTask for select
        main.selectAll('.' + CLASS.selectedXceedTask).filter($$.isBarType.bind($$)).selectAll('circle').remove();
    ...
    ChartInternal.prototype.classXceedTask = function (d) {
        return this.classShapes(d) + this.generateClass(CLASS.XceedTask, d.id);
    };
        ...
        $$.eventRect.attr('x', x).attr('y', y).attr('width', w).attr('height', h).on('mouseout', config.interaction_enabled ? function () {
            ...
            if (config.point_focus_expand_enabled) {
                ...
                selectedData.forEach(function (d) {
                    $$.expandXceedTask(d.index, d.id, false);
                });
            }
    ...
    ChartInternal.prototype.selectPoint = function (target, d, i) {
        ...
        $$.main.select('.' + CLASS.selectedXceedTask + $$.getTargetSelectorSuffix(d.id)).selectAll('.' + CLASS.selectedCircle + '-' + i).data([d]).enter().append('circle').attr("class", function () {
    ...
    ChartInternal.prototype.unselectPoint = function (target, d, i) {
        ...
        $$.main.select('.' + CLASS.selectedXceedTask + $$.getTargetSelectorSuffix(d.id)).selectAll('.' + CLASS.selectedCircle + '-' + i).transition().duration(100).attr('r', 0).remove();
    };
    ...
    ChartInternal.prototype.updateTargetsForLine = function (targets) {
        var $$ = this,
            ...
            classXceedTask = $$.classXceedTask.bind($$),
            classFocus = $$.classFocus.bind($$);
        ...
        // XceedTask for each data point on lines
        mainLineEnter.append('g').attr("class", function (d) {
            return $$.generateClass(CLASS.selectedXceedTask, d.id);
        });
        mainLineEnter.append('g').attr("class", classXceedTask).style("cursor", function (d) {
            return config.data_selection_isselectable(d) ? "pointer" : null;
        });
        // Update date for selected XceedTask
        targets.forEach(function (t) {
            $$.main.selectAll('.' + CLASS.selectedXceedTask + $$.getTargetSelectorSuffix(t.id)).selectAll('.' + CLASS.selectedCircle).each(function (d) {
    ...
    ChartInternal.prototype.updateCircle = function (cx, cy) {
        var $$ = this;
        var mainCircle = $$.main.selectAll('.' + CLASS.XceedTask).selectAll('.' + CLASS.circle).data($$.lineOrScatterData.bind($$));
    ...
    ChartInternal.prototype.redrawCircle = function (cx, cy, withTransition, transition) {
        var $$ = this,
            selectedXceedTask = $$.main.selectAll('.' + CLASS.selectedCircle);
        return [(withTransition ? $$.mainCircle.transition(transition) : $$.mainCircle).style('opacity', this.opacityForCircle.bind($$)).style("fill", $$.color).attr("cx", cx).attr("cy", cy), (withTransition ? selectedXceedTask.transition(transition) : selectedXceedTask).attr("cx", cx).attr("cy", cy)];
    };
    ...
    ChartInternal.prototype.getXceedTask = function (i, id) {
        var $$ = this;
        return (id ? $$.main.selectAll('.' + CLASS.XceedTask + $$.getTargetSelectorSuffix(id)) : $$.main).selectAll('.' + CLASS.circle + (isValue(i) ? '-' + i : ''));
    };
    ChartInternal.prototype.expandXceedTask = function (i, id, reset) {
        var $$ = this,
            r = $$.pointExpandedR.bind($$);
        if (reset) {
            $$.unexpandXceedTask();
        }
        $$.getXceedTask(i, id).classed(CLASS.EXPANDED, true).attr('r', r);
    };
    ChartInternal.prototype.unexpandXceedTask = function (i) {
        var $$ = this,
            r = $$.pointR.bind($$);
        $$.getXceedTask(i).filter(function () {
